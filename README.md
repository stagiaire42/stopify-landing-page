...
<<<<<<< HEAD
Changer la version dans le script `docker-image/_script/hugo.sh` via la variable `HUGO_VERSION`.  
Il faut ensuite reconstruire l'image.
||||||| 143e9b8
\\ À écrire \\
=======
\\ À écrire \\
...
>>>>>>> 079a226dbbf4995437d781ff9177780925675fb4
